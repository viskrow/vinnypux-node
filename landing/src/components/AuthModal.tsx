...
export default function AuthModal({ view, onViewChange, onClose }: Props) {
  useEffect(() => {
  ...
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal glass-bright">
        ...
        <p className="modal-footer-text">
          {view === 'signin' ? (
            <>Don't have an account?{' '}
              <button onClick={() => onViewChange('signup')}>Create one</button>
            </>
          ) : (
            <>Already have an account?{' '}
              <button onClick={() => onViewChange('signin')}>Sign in</button>
            </>
          )}
        </p>
      </div>
  ...
  return (
    <div className="modal-form">
      ...
      <div className="form-field">
        ...
        <input className="form-input" type="email" placeholder="you@example.com" autoFocus />
      </div>
      <div className="form-field">
  ...
  return (
    <div className="modal-form">
      ...
      <div className="form-field">
        ...
        <input className="form-input" type="text" placeholder="Alex Johnson" autoFocus />
      </div>
      <div className="form-field">
        <label className="form-label">Email</label>
